plot4 <- function() {
  ...
  par(mfrow=c(2,2))
  # plot top left graph
  with(all_data, plot(DateTime, Global_active_power, type="l",
                      ylab="Global Active Power", xlab=""))
  # plot top right graph
  with(all_data, plot(DateTime, Voltage, type="l",
                      ylab="Voltage", xlab="datetime"))  
  # plot bottom left graph
  with(all_data, plot(DateTime,Sub_metering_1,type="l", col="black", 
  ...
  with(all_data, plot(DateTime, Global_reactive_power, type="l",
